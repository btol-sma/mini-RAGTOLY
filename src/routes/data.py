...
async  def process_endpoint(request: Request,project_id:str , process_request : ProcessRequest):
    ...
    if process_request.file_id:
        asset_record = await asset_model.get_asset_reocrd(asset_project_id= project.id, asset_name=process_request.file_id)
        ...
        project_files = await asset_model.get_all_project_assets(asset_project_id=project.id, asset_type=AssetTpyeEnum.FILE.value)
        project_files_ids ={
